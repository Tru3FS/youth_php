...
?>	
  ...
  <tr class="<?php echo $row2['Sales_Code'];?>">
        ...
        <td  class="cc"  style="height: 70px !important;"><span><?php echo $row2['Month_Qty'];?></span></td>
        
        <td class="align_R cc" style="height: 70px !important;"><span class='price'><?php echo number_format($row2['Unit_Price']);?></span></td>
        
        <td class="cc"  style="height: 70px !important;"><?php echo $s_people;?></td>
        
        <td class="cc"  style="height: 70px !important;"><a href="#!"><?php echo $s_txt2;?></a><!--<br><?php echo $total_people;?>/<?php echo $cur_people;?>--></td>
        ...
        $this.waypoint(function() {
		    ...
		    if(percentage < 1){
		     ...
		     $this.animate({'width':'5%'}, 800);
			  ...
			  $this.animate({'width':''+percentage+'%'}, 800);
			  $this.css({'color':'black', 'background':'#a7a7a7'}, 800);
            }else{
