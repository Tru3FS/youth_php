...
.rank_list2 td{
    height: 70px;
    padding-right: 0px;
    border-top: 1px solid #f3f3f3;    float: left;padding-left: 15px;
}
.rank_list2 tr{
display:none;
}
...
if ($("#record_table tr.<?php echo $row2['Sales_Code'];?>").length < 2)
{
...
}else if ($("#record_table tr.<?php echo $row2['Sales_Code'];?>").length < 3)
{
