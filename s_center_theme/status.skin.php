...
.content_top_tit > span > i {font-style: normal;color:#125fac;    }
...
?>	
	...
	$tetc_people=0;
    $tcur_people=0;		
$sqlc="SELECT  a.Sales_Item_Name,a.Sales_Code, a.Start_Time, a.End_Time, b.Program_Sub_Name, b.Unit_Price,
       a.Capacity, a.Capacity_On_OffLine, a.Capacity_OnLine, a.Capacity_OffLine,f_week_name(a.Use_Week) as Week_Name
...
$ttot_people=0;	
    ...
    $tcur_people=0;		
	$td_people=0;
$sqlc="SELECT  a.Sales_Item_Name,a.Sales_Code, a.Start_Time, a.End_Time, b.Program_Sub_Name, b.Unit_Price, a.Class_Code,
       a.Capacity, a.Capacity_On_OffLine, a.Capacity_OnLine, a.Capacity_OffLine,f_week_name(a.Use_Week) as Week_Name
          FROM TB_SaleItem       a INNER JOIN
          TB_SaleItem_Price b ON a.Center_ID = b.Center_ID AND a.Sales_Code = b.Sales_Code
         WHERE a.Center_ID          = '01'
...
$ct_count2 =  sql_num_rows($resultc);
       ...
       $sql3="SELECT a.Sales_Item_Name, a.Start_Time, a.End_Time, b.Program_Sub_Name, b.Unit_Price,
       a.Capacity, a.Capacity_On_OffLine, a.Capacity_OnLine, a.Capacity_OffLine,  b.Sales_Code
         ...
         AND a.Sales_Item_Name ='$Sales_Item_Name' limit 1 ";
$result3 = sql_fetch($sql3);

$sales_code=$result3['Sales_Code'];
$IDX=$result3['IDX'];

$sqlc="SELECT Capacity_On_OffLine,c.Detail_Name as Lesson_Target,
		(SELECT COUNT(*)
...
$total_people2=$result3['Capacity'];
...
<?php }?>
<tr class="tfoot" >
								<td class="txt_left" rowspan='2'>
									강습반 소계(<?php echo $ct_count2;?>과목)
								</td>
								<td>
