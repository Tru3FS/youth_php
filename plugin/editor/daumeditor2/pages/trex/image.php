...
include_once(BV_EDITOR_LIB);

    $daumeditor_path = BV_PLUGIN_PATH.'/editor/daumeditor2';
    $daumeditor_url = BV_EDITOR_URL.'/daumeditor2';
...
<?
$daumeditor_path = BV_PLUGIN_PATH.'/editor/daumeditor';
$daumeditor_url = "http://vorfeed.dothome.co.kr/plugin/editor/daumeditor";
?>
<link rel="stylesheet" href="<?echo $daumeditor_url?>/css/popup.css" type="text/css" charset="utf-8"/>
<link rel="stylesheet" type="text/css" href="<?php echo $daumeditor_url;?>/css/uploadify.css">
<style type="text/css">
body {
...
<script src="<?echo $daumeditor_url?>/js/popup.js" type="text/javascript" charset="utf-8"></script>
<script src="https://code.jquery.com/jquery-1.12.4.min.js" type="text/javascript"></script>
<script src="<?echo $daumeditor_url?>/js/jquery.uploadify.min.js" type="text/javascript"></script>
...
jQuery(document).ready(function() {
    jQuery("#file_upload").uploadify({
        ...
        , swf : "<?php echo $daumeditor_url;?>/module/uploadify.swf"            // 파일 업로드 이벤트에 사용될 플래쉬 파일
        , uploader : "<?php echo $daumeditor_url;?>/module/uploadify.php"    // 파일 업로드를 수행할 php 파일
