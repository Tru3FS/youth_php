...
$key_dir = NC_OKNAME_PATH.'/key';
if(!is_dir($key_dir)) {
    alert_close(NC_PLUGIN_DIR.'/'.NC_OKNAME_DIR.' 에 key 디렉토리를 생성해 주십시오.\\n\\n디렉토리 생성 후 쓰기권한을 부여해 주십시오. 예: chmod 707 key');
}
