...
if(PHP_INT_MAX == 2147483647) // 32-bit
    $cb_encode_path = 'http://112.217.123.82:10001/Noble/plugin/nice2/bin/CPClient';
else
    $cb_encode_path = 'http://112.217.123.82:10001/Noble/plugin/nice2/bin/CPClient_x64';
...
//$reqseq = `$cb_encode_path SEQ $sitecode`;
    ...
    $returnurl = "http://112.217.123.82:10001/Noble/plugin/nice2/checkplus_success.php";	// 성공시 이동될 URL
    $errorurl = "http://112.217.123.82:10001/Noble/plugin/nice2/checkplus_fail.php";		// 실패시 이동될 URL
...
<body>
	...
	업체정보 암호화 데이타 : [<?php echo $enc_data;?>]<br><br>
