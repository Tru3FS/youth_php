...
$json_string = CF_Basket_Insert ($cx_id, $sales_division, get_session("m_code"), $sales_code, $sales_item_name, $week_name, $month_qty, $unit_price, $start_date, $end_date, $vat_yn, get_session("m_id"), $url, $ip);
