...
<!--<li id="" class="menu-item current_page_item"><a href="/faq/faq.php?co_id=faq&amp;tmenu=5&amp;smenu=1"><span>자주 묻는 질문</span></a></li>-->
					...
					<li id="" class="menu-item"><a href="#!"><span>스포츠센터</span></a>
  <!--<ul class="sub-menu">
	...
	<li id="" class="menu-item "><a href="#!"><span>강좌예약</span></a></li>
					...
					<li id="" class="menu-item "><a href="#!"><span>문화센터</span></a>
  <ul class="sub-menu">
<li id="" class="menu-item "><a href="#!"><span>이용안내</span></a></li>
	<li id="" class="menu-item "><a href="#!"><span>강좌예약</span></a></li>
</ul>
		...
		<li id="" class="menu-item "><a href="#!"><span>오시는길</span></a>
			...
			<li id="" class="menu-item blank"><a href="#!" target="_blank"><span>서울특별시 공공서비스 예약</span></a>
...
<nav class="tab_menu_container" style="display:block;">
				...
				<li class="menu-item  <?php if($page_info=='index' || $n_type=='program_view'){?>current-menu-item current_scroll<?php }?>"><a href="<?php echo NC_URL; ?>/?center_id=<?php echo $_SESSION['center_id'];?>"><span>수강신청</span></a> 
				<!--<ul class="sub-menu">
	<li id="" class="menu-item "><a href="/s_sports/"><span>이용안내</span></a></li>
	<li id="" class="menu-item "><a href="#!"><span>강좌예약</span></a></li>
</ul>--></li>
<li class="menu-item  <?php if($page_info=='guide'){?>current-menu-item current_scroll<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/guide.php?center_id=01"><span>수강안내</span></a>
<ul class="sub-menu">
<li id="" class="menu-item <?php if($page_info=='guide' && $center_id=='01'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/guide.php?center_id=01"><span>스포츠센터</span></a></li>
	<li id="" class="menu-item <?php if($page_info=='guide' && $center_id=='02'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/guide.php?center_id=02"><span>문화센터</span></a></li>
</ul></li>

 <li class="menu-item <?php if($page_info=='status'){?>current-menu-item current_scroll<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/status.php?center_id=01"><span>접수현황</span></a>
 <!--<ul class="sub-menu">
<li id="" class="menu-item <?php if($page_info=='status' && $center_id=='01'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/status.php?center_id=01"><span>스포츠센터</span></a></li>
	<li id="" class="menu-item <?php if($page_info=='status' && $center_id=='02'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/status.php?center_id=02"><span>문화센터</span></a></li>
</ul>-->
 </li>
 <?php if ($is_member) {?><li class="menu-item <?php if($page_info=='mypage'){?><?php }?>" id="mypage_nav"><a href="#!"><span>마이페이지</span></a>
 <ul class="sub-menu">
<li id="" class="menu-item <?php if($page_info=='mypage_leture' && $status=='001'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=001"><span>강좌신청현황</span></a></li>
	<li id="" class="menu-item <?php if($page_info=='mypage_leture' && $status=='002'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=002"><span>강좌이력현황</span></a></li>
	<li id="" class="menu-item <?php if($page_info=='mypage_leture' && $status=='003'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=003"><span>환불신청현황</span></a></li>
</ul></li><?php }?>
<!--<li class="menu-item  menu-item-189"><a href="#!"><span>오시는길</span></a></li>-->
<li class="menu-item  blank"><a href="#!" target="_blank"><span></span></a></li>
</ul>
                <a href="#" class="total_menu_open_button total_menu_open"><span class="sr_only">전체 메뉴 열기</span></a>
            </nav>

 <div class="member_menu_container desktop" id= "member_menu_container">
                <ul class="member_menu">
				
			                  
                        <?php if ($is_member) {?>
						<li><a id="header_login_btn" href="<?php echo NC_MEMBER_URL; ?>/logout.php">로그아웃</a></li> <li  class="my"><a href="<?php echo NC_MYPAGE_URL; ?>/index.php">마이페이지</a></li><li class="mylecture"><!--<a href="<?php echo NC_MYPAGE_URL; ?>/m_edit_step_01.php" class="">회원정보수정</a>--><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php" >내강좌</a></li>
						<?php }else{?>
						<li><a id="header_login_btn" <?php if(($n_type=="login") || ($n_type=="program_view")){?><?php }else{?>class="open_in_modal_page xl_open_in_modal_popup xl_open_in_modal_popup_narrow"<?php }?> href="<?php echo NC_MEMBER_URL; ?>/login.php">로그인</a></li>         
						<li><a id="header_register_btn" href="<?php echo NC_MEMBER_URL; ?>/member_division.php" class="">회원가입</a></li>
						<?php } ?>
                                    </ul>
                ...
                <div class="small_menu_area">
                    ...
                    <div class="small_depth_nav">
                        <div class="small_depth_nav_inner">
							...
							<li class="menu-item  menu-item-has-children <?php if($n_type=='index' || $n_type=='program_view'){?>current-menu-item<?php }?>"><a href="<?php echo NC_URL; ?>/"><span>수강신청</span></a>
<ul class="sub-menu">
	<li class="menu-item  <?php if($n_type=='index' && $center_id=='01'){?>current-menu-item<?php }?>"><a href="<?php echo NC_URL; ?>/index.php?center_id=01&cc_id=01&z_center_idx=1&z_center=스포츠센터"><span>스포츠센터</span></a></li>
	<li class="menu-item  <?php if($n_type=='index' && $center_id=='02'){?>current-menu-item<?php }?>"><a href="<?php echo NC_URL; ?>/index.php?center_id=02&cc_id=02&z_center_idx=2&z_center=문화센터"><span>문화센터</span></a>
	</ul>
</li>
							<li class="menu-item  menu-item-has-children <?php if($n_type=='guide'){?>current-menu-item<?php }?>"><a href="#!"><span>수강안내</span></a>
<ul class="sub-menu">
	<li class="menu-item  <?php if($n_type=='guide' && $center_id=='01'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/guide.php?center_id=01"><span>스포츠센터</span></a></li>
	<li class="menu-item  <?php if($n_type=='guide' && $center_id=='02'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/guide.php?center_id=02"><span>문화센터</span></a>
	<!--	<ul class="sub-menu">
...
<li class="menu-item  menu-item-has-children <?php if($n_type=='status'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/status.php?center_id=01"><span>접수현황</span></a>
<ul class="sub-menu">
	<li class="menu-item <?php if($n_type=='status' && $center_id=='01'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/status.php?center_id=01"><span>스포츠 · 문화센터 접수현황</span></a></li>
	<!--<li class="menu-item <?php if($n_type=='status' && $center_id=='02'){?>current-menu-item<?php }?>"><a href="<?php echo NC_CENTER_URL; ?>/status.php?center_id=02"><span>문화센터</span></a></li>-->
	<!--<li class="menu-item  menu-item-65180"><a href="#!"><span>오시는길</span></a></li>-->
</ul>
</li>
<?php if ($is_member) {?>
...
<ul class="sub-menu">
<li class="menu-item   <?php if($n_type=='mypage'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/index.php"><span>메인페이지</span></a></li>
	<li class="menu-item   <?php if($n_type=='member_edit'){?>current-menu-item<?php }?>""><a href="<?php echo NC_MYPAGE_URL; ?>/m_edit_step_01.php"><span>회원정보수정</span></a></li>
	<li class="menu-item  menu-item-has-children <?php if($n_type=='mypage_lecture'){?>current_page_ancestor active<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=001"><span>내강좌</span></a>
		<ul class="sub-menu"  <?php if($n_type=='mypage_lecture'){?>style="display:block"<?php }?>>
		<li class="menu-item  <?php if($n_type=='mypage_lecture' && $status=='001'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=001"><span>강좌신청현황</span></a></li>
		<li class="menu-item  <?php if($n_type=='mypage_lecture' && $status=='002'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=002"><span>강좌이력현황</span></a></li>
		<li class="menu-item  <?php if($n_type=='mypage_lecture' && $status=='003'){?>current-menu-item<?php }?>"><a href="<?php echo NC_MYPAGE_URL; ?>/lindex.php?status=003"><span>환불신청현황</span></a></li>
	</ul>
</li>
	<li class="menu-item  "><a href="<?php echo NC_MEMBER_URL; ?>/logout.php"><span>로그아웃</span></a></li>
</ul>
</li>
<?php } ?>
...
<div class="mobile_nav_bar">
        <?php if ($is_member) {?> <a class="mobile_nav_btn mylecture" href="<?php echo NC_MYPAGE_URL;?>/lindex.php?status=001"><i></i><span>내강좌</span></a><?php }else{?> <a class="mobile_nav_btn call" href="tel:031-208-8000"><i></i><span>콜센터</span></a><?php } ?>
        <a class="mobile_nav_btn weekly" href="<?php echo NC_URL; ?>"><i></i><span>강좌예약</span></a>
        <a class="mobile_nav_btn home" href="<?php echo NC_URL; ?>"><i></i><span>홈</span></a>
        <?php if ($is_member) {?><a class="mobile_nav_btn account" href="<?php echo NC_MYPAGE_URL; ?>"><i></i><span lang='en'>MY</span></a><?php }else{?><a class="mobile_nav_btn account nc-login-first" href="<?php echo NC_MEMBER_URL; ?>/login.php"><i></i><span lang='en'>MY</span></a><?php } ?>
