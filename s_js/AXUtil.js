...
var axf = AXUtil = {
	...
	timekey: function () {
		var d = new Date();
		return ("1" + d.getHours().setDigit(2) + d.getMinutes().setDigit(2) + d.getSeconds().setDigit(2) + d.getMilliseconds());
	},
	/**
...
Object.extend(String.prototype, (function () {
	...
	/**
	 * 문자열에서 특수문자를 HTML 엔티티로 변환한다. (2015.12.22 추가)
	 * @method String.replaceSpecialChars
	 * @returns {String}
	 * @example
	 * "AXJ&AXJ".String.replaceSpecialChars(); -> "AXJ&amp;AXJ"
	 */
