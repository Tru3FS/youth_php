...
<?php } else if(get_session('center_id')=='104'){?>
...
<br>
<li><span>이용안내</span><br>
1.	본인의 부주의로 시설물을 훼손할 시에는 즉시 변상하여야 합니다.<br>
2.	시설을 이용함에 있어서 지도자(또는 직원)의 지도에 반하는 일체의 행위를 하지 않으며, 안전사고 예방에 항상
최선을 다하겠습니다. 만약 본인의 부주의로 인하여 안전사고 및 개인소지품 분실 시, 이로 인한 일체의 민형사상
손해배상(책임)을 센터에 요구하지 않겠습니다.
<br>
...
임산부 및 지병이 있으신 분은 수강 전 반드시 지도자와 상담 후 허가 받아 등록하여야 합니다.<br>
6.	회원 접수기간을 준수하며 이를 불이행하여 접수를 못하게 될 경우 이의를 제기하지 않겠습니다.<br>
* 기존회원접수기간 매달 19일~25일, 신규회원접수기간 26일~ 마감시까지<br>
(위 접수기간은 센터 사정으로 인해 변경될 수 있습니다.)<br>
...
<div class="tableWrap management">
				<div class="scrollDiv">
    				<div class="tableR">
						...
						<tr>
						<td>평생교육 프로그램</td>
						<td style="text-align:left;margin-left:8px;padding: 8px 8px;">개강 전 환불 : 100% 환불<br>
개강 후 환불 : 일자 계산하여 남은 수업일 계좌환불(수강자 본인명의 입출금통장)<br>
<span style="color: #e51b13;">(단, 수업 개강 1/2경과후에는 환불불가)</span>
</td>
						</tr>
			
					<tr>
						<td>생활체육 프로그램</td>
						<td  style="text-align:left;margin-left:8px;padding: 8px 8px;">개강 전 환불 : 수강료10% 공제후 계좌환불<br>
개강 후 환불 : 환불요청일까지의 이용일수에 해당하는 금액과 총 이용금액의 10% 공제 후 계좌환불
...
<span style="color: #e51b13;">* 환불 신청서를 작성하여 제출해 주시면 계좌로 입금됩니다.(15일이내 처리)<br>
* 온라인으로 환불요청시 안내데스크(02-6715-6600~1)로 알려주셔야 환불처리가능합니다.<br></span>
* 구비서류 본인:(신분증, 통장사본), 어린이프로그램(부모신분증, 통장사본, 등본 또는 가족관계 증명서 1통)<br><br>

10. 자가차량 이용 시 교통안전에 주의하며, 주차장에서 본인 부주의로 인해 발생한 사고는 본인이 책임져야 합니다.<br>
11. 신규가입 시 신분증을 반드시 지참하여야 합니다.<br>
12. 접수 완료 후 반드시 영수증을 수령하시고, 반드시 회원약관(서약서)를 숙지하여 주시기 바랍니다.<br>
<br>
<br>
</li>
<br><br>
...
<li><span>이용안내</span><br>
1.	본인의 부주의로 시설물을 훼손할 시에는 즉시 변상한다.<br>
2.	시설을 이용함에 있어서 지도자(또는 직원)의 지도에 반하는 일체의 행위를 하지않으며, 안전사고 예방에 항상 최선을 다한다. 만약 본인의 부주의로 인하여 안전사고 및 개인소지품 분실시, 이로 인한 일체의 민형사상 손해배상을 문화의집에 요구하지 않는다.
<br>
3.	타프로그램을 무단 이용하다가 적발시는 해당프로그램 수강료의 30배 징수 및 고발조치에 이의를 제기하지 않는다.<br>
4. 수강료 환불시에는 방문접수만 가능하며 아래와 같이 처리함에 동의한다.<br>
•   프로그램 개시 1일전까지 취소신청 한 경우 : 수강료 100% 환불<br>
•	프로그램 개시일 이후에 취소신청 한 경우 : 수강료 총액을 강습일 잔여 일자 계산하여 환불(강습기간의 1/2 경과 이후는 환불 불가)<br>
•	등록인원 미달로 인한 강좌 폐강 : 전액 환불<br>
•	단, 재료비가 발생하는 프로그램의 경우 수강료 환불은 가능하나 재료비 환불이 불가할 수 있음<br><br>
※ 본 환불 규정은 공정거래위원회 「소비자분쟁해결기준」 준용(평생교육시설운영업)<br>
• 환불방법은 환불 신청서를 작성하신 후 처리 절차에 의해 계좌 입금
<br>
</li>
<br>
<!--
