...
<div id="cont_head">
		<h2>아이디찾기</h2>
		<div id="location">
			<ul id="nc-breadcrumb" class="nc-breadcrumb"><li class="nc-breadcrumb__item nc-breadcrumb__item--home"><a href="<?php echo NC_URL;?>/?center_id=<?php echo $_SESSION['center_id'];?>" class="home">Home</a></li> <li class="nc-breadcrumb__item nc-breadcrumb__item--separator"><span>&gt;</span></li> <li class="nc-breadcrumb__item nc-breadcrumb__item--current"><span>회원</span></li><li class="nc-breadcrumb__item nc-breadcrumb__item--separator"><span>&gt;</span></li> <li class="nc-breadcrumb__item nc-breadcrumb__item--current"><span>아이디찾기</span></li></ul>

		</div>				
	</div>
<div class="article sub-member-register">
<div class="article_header large-screen-only" style="display:none;"><div class="wrap"><div class="article_header_inner"><h1 class="article_title" lang="ko">아이디찾기</h1></div></div></div>
                ...
                <div class="wrap">
                    ...
                    <div class="nc-form-header">
                      <h3 class="nc-form-header__title">
                            <span class="nc-form-header__title-point">아이디</span>를 잊으셨나요?
                            <!--가치있는 노후의 행복 파트너,<p><b class="nc-form-header__title-bold">삼성노블카운티</b>입니다.--></p>
                        </h3>
                        <p class="nc-form-header__desc">회원가입시 등록한 연락처 및 이름을 입력해주세요.</p>
                    </div>

                      <form class="nc_frm id-search-form" id="nc_frm_id_search" method="post" autocomplete="off">
                      ...
                      <div class="nc_frm__wrap">
                        ...
                        <div class="nc_frm__control">
                          <button class="nc_frm__action2"/>아이디확인</button>
                        </div><!-- .nc_frm__control -->
