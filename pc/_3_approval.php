...
//Mainpay.toParent('https://sports.samsungnc.com/Noble/mypage/lindex.php?status=002');
opener.document.location.href="https://sports.samsungnc.com/Noble/mypage/lindex.php?status=002";


   Mainpay.isOpenWindow = true;
   Mainpay.bgDim(false);
   self.close();        
